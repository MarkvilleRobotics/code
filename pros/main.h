...
#define BUMPER_2 2
#define BUMPER_E 12
#define LINE_TRACKER_PORT_L 1//analog
#define LINE_TRACKER_PORT_C 2
#define LINE_TRACKER_PORT_R 3
#define LIGHT_TRACKER_PORT_R 4
#define LIGHT_TRACKER_PORT_B 5
#define LIGHT_TRACKER_PORT_Y 6
Ultrasonic sonarl;//digital
Ultrasonic sonarr;
